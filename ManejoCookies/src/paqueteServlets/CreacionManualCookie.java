...
@WebServlet("/CreacionManualCookie")
public class CreacionManualCookie extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (listaCookiesRecibidas != null) {
			...
			response.setHeader("Set-Cookie", "uid=" + cadenaAleatoria + "; Path=/");
			/* Equivalente a
			     Cookie unaCookie = new Cookie("uid","123456");
			     unaCookie.setPath("/");
